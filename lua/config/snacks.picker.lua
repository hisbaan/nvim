...
return {
  ...
  lazy = false,
  keys = {
    { '<leader><Space>', function() Snacks.picker.smart() end,   opts, desc = "Find files" },
    { '<leader>bs',      function() Snacks.picker.buffers() end, opts, desc = "Search Buffers" },
    { '<leader>tg',      function() Snacks.picker.grep() end,    opts, desc = "Live grep" },
    { '<leader>.',       function() Snacks.explorer() end,       opts, desc = "File browser" },
  },
  ---@type snacks.Config
  opts = {
